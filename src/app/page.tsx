...
async function exportPlanAsPdf(plan: IntegrationPlan) {
  ...
  // Title
  page.drawText("Integration Plan", {
    x: MARGIN_X,
    y: yRef.current,
    size: 16,
    font: fontBold,
  ...
  const pdfBytes = (await doc.save()) as BlobPart;
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground text-pretty max-w-2xl mx-auto">
            Transform your resume into a structured 4-week integration plan.
            Upload your PDF and get personalized recommendations for your
            developer journey.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Select the type of integration plan you&#39;d like to generate
              </CardDescription>
            </CardHeader>
            <CardContent>
              <RadioGroup
                value={planType}
                onValueChange={(value) =>
                  setPlanType(value as "frontend" | "backend")
                }
            ...
            <div className="space-y-4">
              <div className="text-center">
                ...
                >
                  <CheckCircle className="w-3 h-3 mr-1" />
                  Analysis Complete (
                  {planSource === "edited" ? "Edited CV" : "Original"})
                </Badge>
              </div>
              <div className="flex justify-end">
                <Button
                  variant="outline"
                  onClick={() => exportPlanAsPdf(displayPlan)}
                >
          ...
          {formPlanMutation.isError && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                {(formPlanMutation.error as Error).message}
              </AlertDescription>
            </Alert>
          )}
        </div>
